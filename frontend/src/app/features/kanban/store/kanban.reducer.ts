...
export const kanbanReducer = createReducer(
  ...
  on(importIssues, (state) => ({ ...state, importingIssues: true, error: null })),
  on(importIssuesSuccess, (state) => ({ ...state, importingIssues: false })),
  on(importIssuesFailure, (state, { error }) => ({ ...state, importingIssues: false, error })),
