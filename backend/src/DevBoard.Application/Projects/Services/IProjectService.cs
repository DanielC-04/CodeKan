...
public interface IProjectService
{
    ...
    Task<ProjectDto?> ConnectGitHubInstallationAsync(Guid ownerUserId, Guid projectId, long installationId, CancellationToken cancellationToken = default);
    Task<bool> IsGitHubInstallationConfiguredAsync(Guid ownerUserId, Guid projectId, CancellationToken cancellationToken = default);
